...
export default () => {
  i18n
    ...
    .then(() => {
          ...
          .then((response) => {
            ...
            if (responseStatus !== 200) {
              ...
              if (parseError.length > 0) {
                ...
                const newPosts = processPosts(posts, id);
      ...
      const processPosts = (posts, feedId) => {
        const processedPosts = posts.map((post) => {
          ...
          return { id: postId, feedId, postTitle, postDescription, postLink, postGuid };
        });
      ...
      const update = () => {
        return refresh(state, getLink, processPosts)
          .then((newPosts) => {
